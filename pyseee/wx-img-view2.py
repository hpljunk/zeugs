...
ABOUT_DIALOG_SIZE = (200,280)
SPLASH_SCREEN_FILENAME = 'splash.jpg'
...
class ImageViewerAbout(wx.Dialog):
    ...
    text = '''<html>
    <h1>if i only would know what i do</h1>
    <p>taking a picture and slice it circular and then put it to a rs232 device</p>
    <p>More information is available at <a href="http://propella.ella">Propella.ella</a>.<p>
    <p>Created 2009/10, Copyright &copy; HPL <a href="mail://tmc@chello.at">tmc@chello.at</a></p>
    </html>'''
...
class Frame(wx.Frame):
    ...
    def __init__(self, parent, id, title):
        ...
        self.panel.SetBackgroundColour('Blue') # make the background of the window white
        self.CreateMenuBar() # create the menu bar object
    ...
    def OnOpen(self, event):
        ...
        filters = 'Image files (*.tif;*.gif;*.png;*.jpg)|*.tif;*.gif;*.png;*.jpg'
    ...
    def ShowBitmap(self):
        ...
        #HPL Make the  image as large as the application's window 
#        self.image = self.image.Resize((50, 50), Image.NEAREST)
        #self.image.Rescale(300, 400) 
...
class App(wx.App):
    def OnInit(self):
        self.frame = Frame(parent=None, id=-1, title='datapropella')
        self.frame.Show()
